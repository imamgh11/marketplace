...
class Admin extends CI_Controller
{
	...
	function kategori_produk()
	{
		...
		$data['title'] = 'Kategori Produk - Sibook Store';
	...
	function tambah_kategori_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Kategori Produk - Sibook Store';
	...
	function edit_kategori_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Produk - Sibook Store';
	...
	function produk()
	{
		$data['title'] = 'Produk - Sibook Store';
	...
	function rekening()
	{
		...
		$data['title'] = 'Rekening - Sibook Store';
	...
	function tambah_rekening()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Rekening - Sibook Store';
	...
	function edit_rekening()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Rekening - Sibook Store';
	...
	function supplier()
	{
		...
		$data['title'] = 'Supplier - Sibook Store';
	...
	function tambah_supplier()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Supplier - Sibook Store';
	...
	function edit_supplier()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Supplier - Sibook Store';
	...
	function konsumen()
	{
		$data['title'] = 'Konsumen - Sibook Store';
	...
	function edit_konsumen()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Konsumen - Sibook Store';
	...
	function detail_konsumen()
	{
		...
		$data['title'] = 'Detail Konsumen - Sibook Store';
	...
	function pesanan_dikirim()
	{
		...
		$data['title'] = 'Masukan Resi - Sibook Store';
	...
	function website()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Identitas Website - Sibook Store';
	...
	function menu()
	{
		...
		$data['title'] = 'Menu Website - Sibook Store';
	...
	function tambah_menu()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Menu Website - Sibook Store';
	...
	function edit_menu()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Menu Website - Sibook Store';
			$data['record'] = $this->model_menu->menu_utama();
	...
	function logo()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Logo Website - Sibook Store';
	...
	function slider()
	{
		...
		$data['title'] = 'Slider - Sibook Store';
	...
	function tambah_slider()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Slider - Sibook Store';
	...
	function edit_slider()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Slider - Sibook Store';
	...
	function halaman()
	{
		...
		$data['title'] = 'Halaman - Sibook Store';
	...
	function tambah_halaman()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Halaman Baru - Sibook Store';
	...
	function edit_halaman()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Halaman Baru - Sibook Store';
	...
	function artikel()
	{
		$data['title'] = 'Artikel - Sibook Store';
	...
	function tambah_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Artikel - Sibook Store';
	...
	function edit_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Artikel - Sibook Store';
			$data['tag'] = $this->model_artikel->tag_artikel();
			$data['record'] = $this->model_artikel->kategori_artikel();
	...
	function tambah_tag_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Tag - Sibook Store';
	...
	function edit_tag_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Tag - Sibook Store';
	...
	function edit_user()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Pengguna - Sibook Store';
	...
	function users()
	{
		$data['title'] = 'Manajemen Pengguna - Sibook Store';
	...
	function tambah_user()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Pengguna - Sibook Store';
	...
	function laporan()
	{
		$data['title'] = 'Laporan Penjualan - Sibook Store';
	...
	function newsletter()
	{
		...
		$data['title'] = 'Newsletter - Sibook Store';
	...
	function tambah_newsletter()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$config['smtp_host'] = "mail.Sibook.com";
			$config['smtp_crypto'] = "ssl";
			$config['smtp_port'] = "465";
			$config['smtp_user'] = "demo-ecommerce@Sibook.com";
			$config['smtp_pass'] = "demo-ecommerce";
			$config['charset'] = "iso-8859-1";
			$config['mailtype'] = "html";
			$config['newline'] = "\r\n";
			$ci->email->initialize($config);
			$ci->email->from('demo-ecommerce@Sibook.com', "Sibook Store");
			...
			$data['title'] = 'Kirim News Letter - Sibook Store';
	...
	function lihat_newsletter()
	{
		...
		$data['title'] = 'Detail Berita - Sibook Store';
	...
	function subscriber()
	{
		$data['title'] = 'Subscriber - Sibook Store';
